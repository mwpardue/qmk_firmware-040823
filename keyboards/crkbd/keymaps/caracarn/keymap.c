...
[_BASE] = LAYOUT_split_3x6_3(
  ...
  OSMLCTL, CTL_A,  ALT_S,   SFT_D,   GUI_F,   KC_G,                         KC_H,    GUI_J,   SFT_K,   ALT_L,   CTL_QUO, OSMRALT,
  OSMLALT, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, OSMRCTL,
                                     ESC_FUN, CAP_NUM, TAB_SYM,    BSP_MSE, SPC_MEH, ENT_HYP
),
...
[_NUMPAD] = LAYOUT_split_3x6_3(
  _______, KC_TAB,  PRVTAB,  KC_UP,   NXTTAB,  TD_SSFL,                      KC_MINS, KC_7,    KC_8,    KC_9,    KC_PSLS, _______,
  _______, KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, TD_SNIP,                      KC_COLN, GUI_4,   SFT_5,   ALT_6,   CTL_PLS, _______,
  _______, LLOCK,   MC_SWLE, MC_SWAP, MC_SWRI, KC_ENT,                       KC_EQL,  KC_1,    KC_2,    KC_3,    KC_DOT,  _______,
                                      _______, _______, _______,    SPC_MEH, KC_0,    KC_ENT
),
...
[_SYMBOL] = LAYOUT_split_3x6_3(
  ...
  _______, SM_PARN, SM_ANGB, SM_CURB, SM_BRAC, _______,                     KC_EQL,  KC_1,    KC_2,    KC_3,    KC_DOT,  _______,
                                      _______, _______, _______,   SPCSFT,  KC_0,    ENT_NUM
),
...
//                                       _______, TAB_NUM, _______,   _______, KC_RPRN, ENT_HYP
// ),

[_MOUSE] = LAYOUT_split_3x6_3(
  _______, _______, MC_SELW, _______, _______, TOBAS,  		                 TD_SSFL, TD_SNIP,  ZOOMIN,  ZOOMOUT, OSL_MAC, _______,
  _______, _______, _______, _______, _______, _______, 		             _______, GUI_VD,   SFT_MUT, ALT_VU,  KC_RCTL, _______,
