...
[_NUMPAD] = LAYOUT_split_3x6_3(
  _______, KC_TAB,  _______, EE_CLR,  _______, TD_SSFL,                      KC_BSLS, KC_7,    KC_8,    KC_9,    KC_SLSH, _______,
  _______, KC_BSPC, OSMLCTL, OSMLSFT, OSMLGUI, TD_SNIP,                      KC_MINS, KC_4,    KC_5,    KC_6,    KC_COLN, _______,
  _______, LLOCK,   _______, _______, OSMLALT, _______,                      KC_EQL,  KC_1,    KC_2,    KC_3,    KC_DOT,  _______,
...
[_SYMBOL] = LAYOUT_split_3x6_3(
  ...
  _______, KC_AT,   KC_BSLS, KC_MINS, KC_UNDS, KC_PIPE,                     KC_PIPE, KC_DLR,  KC_PERC, KC_CIRC, KC_SCLN, _______,
...
[_NAVIGATION] = LAYOUT_split_3x6_3(
  _______, MC_SWAP, MOV_LFT, MC_SWRI, MOV_RGT, _______,  		             WD_LEFT, SEL_WRD,  SEL_LIN, WD_RGHT, PASSPAL, _______,
  _______, KC_CAPS, OSMLCTL, OSMLSFT, OSMLGUI, _______,                  KC_LEFT, KC_DOWN,  KC_UP,   KC_RGHT, _______, _______,
